    ...
    <div className="min-h-screen flex">
      <aside className="w-72 shrink-0 border-r border-[var(--border)] bg-[var(--bg)] sticky top-0 h-screen overflow-y-auto p-5">
        ...
        <div className="mt-8 text-xs text-[var(--fg-muted)] leading-relaxed">
          {l === "zh"
            ? "用 Go 从零渐进构建一个 AutoGPT classic 风格的 agent。每节末尾对照上游 Python 源码。"
            : "Build an AutoGPT-classic-style agent from scratch in Go, session by session. Each chapter ends with the upstream Python source."}
        </div>
      </aside>
